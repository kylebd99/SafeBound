...
#            if not pd.api.types.is_numeric_dtype(table_data[column]):
#                table_data[column] = pd.to_numeric(pd.to_datetime(table_data[column]))
#            else:
#                table_data[column] = table_data[column].round()
